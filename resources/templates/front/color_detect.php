...
<style>
   .lead{ max-width:50rem;margin-bottom:1.4rem;font-size:1.1rem }
    ...
    .drop-zone-label{ color:#BDBDBD;
        position:relative;top:11rem;font-size:1.8rem;text-align:center;pointer-events:none;text-transform:uppercase;
        -webkit-border-radius:8px;-moz-border-radius:8px;-ms-border-radius:8px;-o-border-radius:8px;border-radius:8px}
    @media (min-width: 40rem){.drop-zone-label{top:10.5rem;font-size:2.4rem}}
    .dragging-label{display:none}.dropped-image .run-functions-button{display:none}
</style>
  ...
  <section id="drag-drop" class="drag-drop-section">
    <div class="container">
      ...
      <div id="drop-zone" class="drop-zone">
        ...
        <div class="drop-zone-label dragging-label">Sueltalo!</div>
      </div>
